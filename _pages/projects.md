...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .category-header { color: #f0f0f0; border-bottom-color: #444; }
    .coming-soon-card { background: #1e1e1e; border-color: #444; color: #666; }
  }
</style>
...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h1 class="display-4 font-weight-bold">Research Projects</h1>
            <p class="lead text-muted">Current investigations and future directions.</p>
        </div>
    </div>

    <h2 class="category-header"><i class="fas fa-atom mr-2 text-primary"></i> Antimatter Physics</h2>
    ...
    <span class="sub-category-label"><i class="fas fa-angle-right"></i> Antiproton / Antihydrogen Physics</span>
    <div class="coming-soon-card mb-5">
        <i class="fas fa-tools fa-2x mb-3"></i>
        <h5>Content in Preparation</h5>
        <p class="mb-0">Details regarding Antiproton and Antihydrogen experiments will be updated soon.</p>
    </div>
    ...
    <div class="coming-soon-card mb-5">
        ...
        <h5>Content in Preparation</h5>
        <p class="mb-0">Details regarding J-PET related projects will be updated soon.</p>
    </div>
