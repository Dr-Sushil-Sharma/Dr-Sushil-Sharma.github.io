...
<link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@500;900&family=Rajdhani:wght@300;500&display=swap" rel="stylesheet">
...
<style>
    ...
    .hud-year { font-size: 2.5rem; font-weight: 300; color: rgba(255,255,255,0.2); position: absolute; top: 10px; right: 20px; }
    .hud-title { font-size: 1.2rem; font-weight: 600; line-height: 1.2; margin-bottom: 10px; color: #fff; }
    .hud-author { font-size: 0.9rem; color: #aaa; font-style: italic; margin-bottom: 15px; }
    .hud-btn {
        display: inline-block;
        padding: 6px 15px;
    ...
    .hud-btn:hover { background: #00d2ff; color: #000; text-decoration: none; }
    ...
    .control-btn:hover { background: #00d2ff; color: #000; border-color: #00d2ff; }

    @keyframes pulse { 0% { opacity: 0.4; } 50% { opacity: 1; } 100% { opacity: 0.4; } }
</style>

<div id="universe-container">
    <div id="loading-text">SCANNING ARCHIVES...</div>
    <canvas id="galaxyCanvas"></canvas>
    
    <div class="controls">
        <div class="control-btn" onclick="resetZoom()" title="Reset View"><i class="fas fa-compress-arrows-alt"></i></div>
        <a href="/publications/" class="control-btn" title="Back to List"><i class="fas fa-list"></i></a>
    </div>

    <div id="hud-panel">
        <div class="hud-year" id="hudYear">2024</div>
        <div class="hud-title" id="hudTitle">Select a Node</div>
        <div class="hud-author" id="hudAuthor">...</div>
        <a href="#" id="hudLink" class="hud-btn" target="_blank">Open Paper</a>
    </div>
